"""
Training script for Experiment 2: Patch Training

This script trains the cell staining transfer model using patch-based training:
- Random crop 256x256 patches from original resolution
- Background filtering to remove empty patches
- Batch size: 4

Usage:
    python train_v2.py --name cell_v2 --dataset_mode cell_v2 --batch_size 4
"""
import time
import torch
